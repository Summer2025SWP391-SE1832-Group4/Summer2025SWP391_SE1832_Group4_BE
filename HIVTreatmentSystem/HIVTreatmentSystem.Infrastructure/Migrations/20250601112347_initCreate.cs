...
namespace HIVTreatmentSystem.Infrastructure.Migrations
{
    ...
    public partial class initCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RegimenId = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RegimenName = table.Column<string>(
                        type: "nvarchar(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    DetailedDescription = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    TargetPopulation = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    StandardDosage = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetAudience = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientCodeAtFacility = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    ConsentInformation = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    AnonymousIdentifier = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleAtTimeOfAction = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    AffectedEntity = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    AffectedEntityId = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilityStatus = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentDateTime = table.Column<DateTime>(
                        type: "datetime2",
                        nullable: false
                    ),
                    ...
                    IsAnonymousConsultation = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegimenAdjustments = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    ActualDosage = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReasonForChangeOrStop = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoinfectionDiseases = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    DrugAllergyHistory = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationMethod = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ReminderContent = table.Column<string>(
                        type: "nvarchar(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint(
                        ...
                        "(ReminderType = 'TakeMedication' AND PatientTreatmentId IS NOT NULL AND AppointmentId IS NULL) OR (ReminderType = 'FollowUpAppointment' AND AppointmentId IS NOT NULL AND PatientTreatmentId IS NULL)"
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestType = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    CD4Count = table.Column<int>(type: "int", nullable: true),
                    CD4Unit = table.Column<string>(
                        type: "nvarchar(20)",
                        maxLength: 20,
                        nullable: false,
                        defaultValue: "cells/mm³"
                    ),
                    HivViralLoadValue = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    HivViralLoadUnit = table.Column<string>(
                        type: "nvarchar(20)",
                        maxLength: 20,
                        nullable: false,
                        defaultValue: "copies/mL"
                    ),
                    LabName = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    AttachedFileUrl = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    {
                        1,
                        "Dizziness, abnormal dreams, rash, nausea",
                        "Severe renal impairment, psychiatric disorders",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "EducationalMaterials");

            migrationBuilder.DropTable(name: "ExperienceWorkings");
            ...
            migrationBuilder.DropTable(name: "SystemAuditLogs");

            migrationBuilder.DropTable(name: "TestResults");

            migrationBuilder.DropTable(name: "BlogTags");

            migrationBuilder.DropTable(name: "PatientTreatments");

            migrationBuilder.DropTable(name: "MedicalRecords");

            migrationBuilder.DropTable(name: "StandardARVRegimens");
